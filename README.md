...
- <i class="far fa-exclamation"></i> [Basics of OOP](/pages/oop/basics-of-object-oriented-programming)
- <i class="far fa-exclamation"></i> [UML diagrams](/pages/general/uml-unified-modeling-language)
